    ...
    <footer style={{ background: "#080a10", borderTop: "1px solid rgba(255,255,255,0.06)" }} className="py-16 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-wrap gap-2">
              {certifications.map((cert) => (
                <span key={cert} className="px-2.5 py-1 rounded-full"
                  style={{ border: "1px solid rgba(255,255,255,0.08)", fontSize: "10px", color: "#475569", letterSpacing: "0.04em" }}>
                  {cert}
                </span>
              ))}
            </div>
        ...
        <div className="pt-8 border-t border-white/[0.05] flex flex-col sm:flex-row justify-between gap-3">
          <p style={{ fontSize: "11px", color: "#475569" }}>© 2026 Weill Cornell Medicine. All rights reserved.</p>
          <p style={{ fontSize: "11px", color: "#475569" }}>In most cases, not covered by insurance. Payment required at time of appointment.</p>
        </div>
      </div>
    </footer>
  );
