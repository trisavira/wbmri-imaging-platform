      ...
      <motion.div style={{ y }} className="relative h-full flex items-center max-w-6xl mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 w-full">
        <div className="w-full">
          ...
          {(() => {
            ...
            const renderColumn = (items: typeof faqs, openIdx: number | null, setOpenIdx: (v: number | null) => void, offset: number) => (
                    ...
                    >
                      ...
                      <AnimatePresence initial={false}>
                        {isOpen && (
                          ...
                          >
                            <div style={{ padding: "0 20px 18px", fontSize: "13px", color: "#444444", lineHeight: 1.75 }}>{faq.a}</div>
                          </motion.div>
                        )}
                      </AnimatePresence>
                    </motion.div>
